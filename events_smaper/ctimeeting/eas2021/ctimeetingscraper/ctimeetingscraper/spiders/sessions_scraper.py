...
class SessionsScraper(scrapy.Spider):
    ...
    def scrape_presentation_session_type(self, presentation_dict, presentation_block):
        """
        Scrapes presentation's associated session type.
        """
        try:
            presentation_dict["session_type"] = presentation_block.css(
                ".details")[0].css(".s")[0].css(".property::text").extract_first()
        except:
            pass
    ...
    def scrape_presentation_inner_data(
        ...
        self.scrape_presentation_session_type(presentation_dict, presentation_block)
